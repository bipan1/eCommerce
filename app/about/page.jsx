                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        <h1 className="text-5xl md:text-6xl font-bold mb-6">
                            About <span className="text-[#FC8181]">Himali Basket</span>
                        </h1>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            <div>
                                ...
                                <p className="text-lg text-gray-600 mb-6">
                                    Founded in 2020, Himali Basket began as a small family business with a simple mission: 
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-600">
                                These core values guide everything we do at Himali Basket
                            </p>
                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-white/90 mb-8">
                            Join thousands of satisfied customers who trust Himali Basket for their grocery needs
                        </p>
