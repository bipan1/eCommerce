export default function Footer() {
    return <footer class="w-full bg-green-200 mt-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <p class="py-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Trusted by South asian people in Melbourne and across Australia.</p>
                    ...
                    <a href="javascript:;" class="mt-4 py-2.5 px-5 h-9 block w-fit bg-indigo-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0">
                        Contact us
                    </a>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Customer Care</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Help Center</a></li>
                        <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">How to Buy</a></li>
                        <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Returns and Refunds</a></li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Terms and Policies</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Privacy Policy</a></li>
                        <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Refund Policy</a></li>
                        <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Term of Service</a></li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Payment Methods</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Stripe</a></li>
                        <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Cash on delivery</a></li>
                    </ul>
                </div>
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Customer Care Hours</h4>
                    <p class="text-sm text-gray-500 leading-6 mb-7">8AM - 8PM: Mon - Fri</p>
                </div>
            </div>
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span class="text-sm text-gray-500 ">©<a href="https://pagedone.io/">NepMart</a> 2024, All rights reserved.</span>
